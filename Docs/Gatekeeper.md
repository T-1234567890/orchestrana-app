...
## 3. Allow the App in System Settings
...
> 📌 This does *not* turn off Gatekeeper for other apps — only permits this specific app.
...
If you’re still having trouble opening the app:
- Check that the downloaded file is intact
- Ensure you are running on macOS 14.6 or higher
- Reach out via the project’s **Issues/Discussion** page
